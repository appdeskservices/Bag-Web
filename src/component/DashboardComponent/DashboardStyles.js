...
export const AnalyticsTopContainer = styled.div`
  display: flex;
  justify-content: space-between;
`;

export const AnalyticsHeading = styled.div`
  font-family: "Inter";
  font-style: normal;
  font-weight: 600;
  font-size: 16px;
...
export const DashboardLowerContainer = styled.div`
  width: 75rem;
  left: 0px;
  top: 16px;
  background: #ffffff;
...
export const OrderMovementInfo = styled.div`
  font-family: "Poppins";
  font-style: normal;
  font-weight: 400;
  font-size: 14px;
...
export const TableTopFiltersContainer = styled.div`
  display: flex;
  justify-content: space-between;
  width: 75rem;
  margin-bottom: 2rem;
